            ...
            <figure class="grid grid-cols-1 items-center gap-x-6 lg:gap-x-16 gap-y-8">
                <div class="col-span-2 lg:col-start-1 lg:row-start-2">
                    <blockquote class="relative">
                        <svg class="absolute -top-6 -start-8 size-16 text-tintgreen/30" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <figcaption class="lg:col-start-1 lg:row-start-3">
                    <h1 class="text-lg sm:text-xl font-primary font-medium leading-relaxed text-lightgreen"><?php echo esc_html(get_field('speaker_name')); ?></h4>
                </figcaption>
            </figure>
        </div>
    </div>
...
<section class="px-10 sm:px-24 py-10 sm:py-24 border-b border-neutral-900/5">
    ...
    <a href="<?php echo home_url('/#program'); ?>" target="_blank" class="mt-8 relative inline-flex items-center justify-center px-5 py-2 overflow-hidden text-sm sm:text-base font-secondary font-medium text-lightgreen border-2 border-lightgreen rounded-full shadow-sm group transition duration-300 ease-out hover:shadow-md">
        ...
        <span class="absolute flex items-center justify-center w-full h-full text-lightgreen transition-all duration-300 transform group-hover:translate-x-full ease">Teljes program megtekintése</span>
        <span class="relative invisible">Teljes program megtekintése</span>
    </a>
</section>
...
<section class="px-10 sm:px-24 py-10 sm:py-24 border-b border-neutral-900/5">
    <div class="mb-10 sm:mb-12 text-center">
        <h2 class="text-sm sm:text-base font-primary font-medium text-lightgreen uppercase">Absztraktok</h2>
        ...
        <div class="relative col-span-1 bg-white shadow-md ring-1 ring-neutral-900/5 p-4 rounded-2xl hover:shadow-xl group cursor-pointer overflow-hidden transition-all duration-300">
            ...
            <div class="relative z-5">
                ...
                <div class="pt-3 sm:pt-5 text-sm sm:text-base font-secondary font-medium text-lightgreen">
                    <a href="<?php the_permalink() ?>" class="flex flex-row items-center transition-all duration-300 group-hover:text-white">
