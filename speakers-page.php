...
document.addEventListener('DOMContentLoaded', function () {
    ...
    yearGroups.forEach(group => {
        ...
        if (year === defaultYear) {
            ...
            group.classList.add('grid', 'sm:grid-cols-1', 'md:grid-cols-2', 'lg:grid-cols-3', 'gap-4');
        } else {
            group.classList.add('hidden');
            group.classList.remove('grid', 'sm:grid-cols-1', 'md:grid-cols-2', 'lg:grid-cols-3', 'gap-4');
        }
    });
